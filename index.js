...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Halo @${num.split('@')[0]}\nSelamat datang di group squad kami ya, semoga betah di group ini yaitu *${mdata.subject}*`
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6282317380554@s.whatsapp.net"] // replace this with your number
